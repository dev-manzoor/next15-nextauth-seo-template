...
// Move this to a parent server component or use a different approach
      ...
      <div className="container mx-auto py-8 space-y-8">
        <div className="text-center">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Showcasing modern web development with Zod validation, Zustand state
            management, SEO optimization, and performance best practices for
            2025.
          </p>
        </div>
